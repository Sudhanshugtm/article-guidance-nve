// ABOUTME: English locale bundle for the article creation prototype.
// ABOUTME: Contains reading page config, UI strings, editor sections, and verified facts.
...
export default {
  ...
  article: {
    ...
    listItems: [
      ...
      { title: 'Sessa Orchid Sanctuary', exists: false },
      {
  ...
  reading: {
    ...
    footer: 'Content from Wikipedia, the free encyclopedia',
  },
  ...
  // Editor content — article sections for the outline
  sections: [
    {
      title: 'Introduction',
  ...
  // Editor content — verified facts from Wikidata
  facts: [
    {
    ...
    },
    {
      ...
      references: [{ url: 'https://www.iucnredlist.org/species/15956/5333650' }],
      wikidataUrl: 'https://www.wikidata.org/wiki/Q69581',
    },
    {
      title: 'Russia',
      description: 'taxon range',
      references: [{ url: 'https://www.iucnredlist.org/species/15956A5333650' }],
      wikidataUrl: 'https://www.wikidata.org/wiki/Q69581',
    },
  ],
}
